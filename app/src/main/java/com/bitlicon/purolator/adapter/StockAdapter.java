...
public class StockAdapter extends ArrayAdapter<Producto> {



    public StockAdapter(Context context,  ArrayList<Producto> productos) {
    ...
    public View getView(final int position, View convertview, ViewGroup parent) {
        ...
        convertview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("producto", getItem(position));
